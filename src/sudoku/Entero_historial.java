...
public class Entero_historial {
	...
	public Entero_historial() {
		/*{Precondición: }
		 * {Postcondicón: devuelve un Entero_historial cuyo número es -1 y estadoInicial es false}
		 */
		this.numero=-1;
	...
	public int getNumero() {
		/*{Precondición: }
		 * {Postcondición: devuelve el dato del atributo numero del objeto}
		 */
		return this.numero;
	}
	
	public void setNumero(int numero) {
		/*{Precondición: numero es una variable de tipo entero}
		 * {Postcondición: asigna al atributo numero el parámetro numero}
		 */
		this.numero=numero;
	}
	...
	public boolean getEstadoInicial() {
		/*{Precondición: }
		 * {Postcondición: devuelve cierto si este valor es el estado inicial o falso en caso contrario}
		 */
	...
	public void setEstadoInicial(boolean estadoInicial) {
		 ...
		 * {Postcondición: asigna el parámetro estadoInicial al atributo del objeto llamado estadoInicial}
		 */
		this.estadoInicial=estadoInicial;
	}
}
