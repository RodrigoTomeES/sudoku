...
public class SudokuConSolucion extends Sudoku {
	...
	public SudokuConSolucion(int tamaño) {
		 ...
		 * entre [0,9] y debe ser un cuadrado perfecto} {Postcondición: construye la
		 * superclase así como el atributo gr de dicho objeto}
		 */
	...
	public void anadirNumeroInicial(int numero, int fila, int columna) {
		 ...
		 * entero entre 1 y tamañoSudoku. La variable número será de tipo entero entre
		 * [1,tamañoSudoku]} {Postcondición: llama al método anadirNumeroInicial de la
		 * superclase y añade sú valor como color al grafo}
		 */
	...
	public void eliminarNumeroACasilla(int fila, int columna) {
		/*
		 * {Precondición: la variable fila y columna tienen que ser números de tipo
		 * entero entre 1 y tamañoSudoku} {Postcondición: eliminan de la superclase el
		 * valor, luego elimina el color asociado a ese vértice del grafo}
		 */
	...
	public boolean sePuedeResolverSudoku() {
		/*
		 * {Precondición: } {Postcondición: devuelve cierto si se puede colorear el
		 * grafo y falso en caso contrario}
		 */
	...
	public void resolverSudoku() {
		/*
		 * {Precondición: } {Postcondición: resuelve el sudoku, para ello se remite a
		 * resolver el problema de colorear el grafo}
		 */
		if (this.gr.colorear(super.tamanoSudoku())) {
			...
			while (it.hasNext()) {
				...
				super.anadirNumero(colorAsociado, (vertice - 1) / super.tamanoSudoku() + 1,
						(vertice - 1) % super.tamanoSudoku() + 1);
			}
		} else {
