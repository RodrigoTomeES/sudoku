...
public class Grafo {
	...
	public Grafo() {
		/*
		 * {Precondición: } {Postcondición: inicializa el atributo grafo como un
		 * HasMap<Integer,List<Integer>> y vacío. En dicho mapa la clave es el vértice y
		 * su valor asociado es la lista de vértices asociados}
		 */
	...
	public Map<Integer, List<Integer>> getGrafo() {
		/*
		 * {Precondición: } {Postcondición: devuelve el mapa asociado al grafo}
		 */
		return this.grafo;
	}
	...
	public boolean anadirVertice(Integer vertice) {
		/*
		 * {Precondición: vértice es un parámetro de tipo Integer} {Postcondición:
		 * comprueba si dicho parámetro está, si esta devuelve falso y no lo añade. En
		 * caso contrario lo añade y devuelve cierto}
		 */
	...
	public boolean eliminarVertice(Integer vertice) {
		/*
		 * {Precondición: vértice es un parámetro de tipo Integer} {Postcondición: si se
		 * encontraba dicho vértice devuelve cierto y lo elimina. En caso contrario sólo
		 * devuelve falso.}
		 */
	...
	public boolean anadirArista(Integer vertice1, Integer vertice2) {
		/*
		 * {Precondición: vertice1 y vertice2 son dos parámetros de tipo Integer y deben
		 * existir} {Postcondición: al vertice1 le pone como vértice asociado el 2. Al
		 * vertice2 le asocia el 1. Si la arista ya existía devuelve falso, si no
		 * cierto}
		 */
	...
	public boolean eliminarArista(Integer vertice1, Integer vertice2) {
		 ...
		 * {Postcondición: al vertice1 le elimina como vértice asociado el 2. Al
		 * vertice2 le elimina el 1. Devuelve cierto si la ha podido eliminar}
		 */
		List<Integer> dato1 = (LinkedList<Integer>) this.grafo.get(vertice1);
		List<Integer> dato2 = (LinkedList<Integer>) this.grafo.get(vertice2);
		boolean existe = (dato1.contains(vertice2)) && (dato2.contains(vertice1));
	...
	public int numeroVertices() {
		/*
		 * {Precondición: } {Postcondición: devuelve el número de vértices que hay en
		 * todo el grafo}
		 */
	...
	public boolean estaVertice(Integer vertice1) {
		/*
		 * {Precondición: vertice1 es un parámetro de tipo Integer} {Postcondición: de
		 * vuelve cierto si el grafo contiene a dicho vértice y falso en caso contrario}
		 */
	...
	public Set<Integer> listarVertices() {
		/*
		 * {Precondición: } {Postcondición: devuelve un Set<Integer> con todos los
		 * vértices del grafo}
		 */
	...
	public List<Integer> listarVerticesAdyacentes(Integer vertice) {
		/*
		 * {Precondición: vertice1 es un parámetro de tipo Integer} {Postcondición:
		 * devuelve una Lista de Integers con todos los vértices asociados a uno dado}
		 */
	...
	public Grafo clone() {
		/*
		 * {Precondición: } {Postcondición: devuelve una copia del grafo}
		 */
