...
public class GrafoConColores extends Grafo {
	...
	public GrafoConColores() {
		/*
		 * {Precondición: } {Postcondición: construye la superclase y construye el
		 * atributo verticesColoreado como un HashMap<Integer,Integer>, dónde irá
		 * guardando para cada vértice, su color asociado. Este atributo está formado
		 * por la clave que será el vértice y el valor asociado que es el color}
		 */
		super();
	...
	public boolean anadirColorAVertice(Integer vertice, Integer color) {
		/*
		 * {Precondición: vertice que ya esté en el grafo y color son dos parámetros de
		 * tipo Integer.} {Postcondición: comprueba en la lista de claves si está el
		 * parámetro vértice. Si no está, añade dicho vertice y su color y devuelve
		 * cierto. En caso contrario devuelve falso y no lo añade}
		 */
	...
	public boolean eliminarColorVertice(Integer vertice) {
		/*
		 * {Precondición: vertice es un parámetro de tipo Integer} {Postcondición: si se
	...
	public Integer getColorVertice(Integer vertice) {
		/*
		 * {Precondición: vertice es un parámetro de tipo Integer} {Postcondición:
		 * devuelve el color asociado a dicho vertice}
		 */
	...
	public void borrarTodosLosColores() {
		/*
		 * {Precondición: } {Postcondición: para borrar todos los colores lo que se hace
		 * es borrar todo el mapa de verticesColoreado}
		 */
	...
	public Set<Integer> listarVerticesConColores() {
		/*
		 * {Precondición: } {Postcondición: devuelve un Set<Integer> el cuál contiene
		 * todas las claves del mapa verticesColoreado, ya que todos esos vértiecs
		 * tienen colores}
		 */
	...
	public boolean esColorValido(Integer vertice, Integer color) {
		 ...
		 * {Postcondición: comprueba si es un color válido para dicho vértice. Para ello
		 * comprueba si es distinto del color de sus vértices asociados.}
		 */
	...
	public GrafoConColores clone() {
		/*
		 * {Precondición: } {Postcondición: devuelve una copia del GrafoConColores}
		 */
